...
def convert(args):
    ...
    print('###### [Fluid param name] --> [TF param name]  [param shape] ######')
    print('-------------------------------------------------------------------')
    ...
    for param in tf_fluid_param_name_map:
        ...
        init_value = fluid.global_scope().find_var(tf_fluid_param_name_map[
                                                       param]).get_tensor()
        ...
        print(tf_fluid_param_name_map[param], ' --> ', param, '  ', fluid_shape)
